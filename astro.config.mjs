          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: "v0.30.0",
                  link: "/surveilr/releases/v0_30_0",
                },
                {
                  label: "v0.30.1",
                  link: "/surveilr/releases/v0_30_1",
                },
                {
                  label: "v0.31.0",
                  link: "/surveilr/releases/v0_31_0",
                },
                {
                  label: "v0.31.1",
                  link: "/surveilr/releases/v0_31_1",
                },
                {
                  label: "v0.32.0",
                  link: "/surveilr/releases/v0_32_0",
                },
              ],
            },
          ],
