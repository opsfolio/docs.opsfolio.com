---
title: "Introduction"
description: "Core capability overview and implementation guide for automated security asset assessment."
icon: FileText
index : 0
---
...
* Based on `kalilinux/kali-last-release:latest` with Spry runbook installed.
...
<Step>
#### Run the assessment
* A pre-configured [Spry](https://sprymd.org/) runbook (`eaa-pentest-lite.spry.md`) orchestrates a sequence of lightweight, authorized tests.
...
<Callout type="info" title="Why use EAA?">
...
* **Environment Variable Knobs (Overridable at Runtime)**
...
## Analyst & Executive Deliverables
