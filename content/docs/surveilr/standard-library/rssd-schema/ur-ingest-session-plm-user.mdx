...
| ----------------------------- | ----------- | ----------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_plm_user_id | VARCHAR     |                   | false    | [ur_ingest_session_plm_acct_project_issue](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-project-issue) [ur_ingest_session_plm_comment](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-comment) | \{"isSqlDomainZodDescrMeta":true,"isVarChar":true\}       |
| user_id                       | TEXT        |                   | false    |                                                                                                                                                           |                                                         |
| login                         | TEXT        |                   | false    |                                                                                                                                                           |                                                         |
| email                         | TEXT        |                   | true     |                                                                                                                                                           |                                                         |
| name                          | TEXT        |                   | true     |                                                                                                                                                           |                                                         |
...
![er](/standard-library/rssd-schema/ur_ingest_session_plm_user.svg)