...
| party_id           | VARCHAR     |                   | false    | [party](/surveilr/standard-library/rssd-schema/party)             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| person_type_id     | ULID        |                   | false    | [person_type](/surveilr/standard-library/rssd-schema/person_type) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
...
| gender_id          | ULID        |                   | false    | [gender_type](/surveilr/standard-library/rssd-schema/gender_type) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
| sex_id             | ULID        |                   | false    | [sex_type](/surveilr/standard-library/rssd-schema/sex_type)       | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
...
![er](/standard-library/rssd-schema/person.svg)