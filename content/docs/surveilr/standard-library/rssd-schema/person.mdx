...
| person_type_id     | ULID        |                   | false    | [person_type](/surveilr/standard-library/rssd-schema/person-type) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
...
| gender_id          | ULID        |                   | false    | [gender_type](/surveilr/standard-library/rssd-schema/gender-type) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
| sex_id             | ULID        |                   | false    | [sex_type](/surveilr/standard-library/rssd-schema/sex-type)       | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
