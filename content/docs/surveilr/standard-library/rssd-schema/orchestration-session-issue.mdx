...
| ------------------------------ | ------- | ------- | -------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| orchestration_session_issue_id | UUID    |         | false    | [orchestration_session_issue_relation](/surveilr/standard-library/rssd-schema/orchestration-session-issue_relation) |                                                                                                         | orchestration_session_issue primary key and internal label (UUID)                  |
| session_id                     | VARCHAR |         | false    |                                                                                                                           | [orchestration_session](/surveilr/standard-library/rssd-schema/orchestration-session)             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`                                  |
| session_entry_id               | VARCHAR |         | true     |                                                                                                                           | [orchestration_session_entry](/surveilr/standard-library/rssd-schema/orchestration-session-entry) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`                                  |
...
![er](/standard-library/rssd-schema/orchestration_session_issue.svg)