...
| ------------------------------------- | ----------- | ----------------- | -------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_imap_acct_folder_id | VARCHAR     |                   | false    | [ur_ingest_session_imap_acct_folder_message](/surveilr/standard-library/rssd-schema/ur-ingest-session-imap-account-folder-message) |                                                                     | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
