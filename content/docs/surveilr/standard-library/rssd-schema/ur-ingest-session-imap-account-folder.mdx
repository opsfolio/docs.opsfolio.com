...
| ------------------------------------- | ----------- | ----------------- | -------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_imap_acct_folder_id | VARCHAR     |                   | false    | [ur_ingest_session_imap_acct_folder_message](/surveilr/standard-library/rssd-schema/ur-ingest-session-imap-account-folder_message) |                                                                     | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
| ingest_account_id                     | VARCHAR     |                   | false    |                                                                                             | [ur_ingest_session_imap_account](/surveilr/standard-library/rssd-schema/ur-ingest-session-imap-account) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_imap_acct_folder.svg)