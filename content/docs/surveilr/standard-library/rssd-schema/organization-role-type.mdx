...
| ------------------------- | ----------- | ----------------- | -------- | ----------------------------------------- | ------------------------------------------------------- |
| organization_role_type_id | ULID        |                   | false    | [organization_role](/surveilr/standard-library/rssd-schema/organization_role) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
| code                      | TEXT        |                   | false    |                                           |                                                         |
| value                     | TEXT        |                   | false    |                                           |                                                         |
...
![er](/standard-library/rssd-schema/organization_role_type.svg)