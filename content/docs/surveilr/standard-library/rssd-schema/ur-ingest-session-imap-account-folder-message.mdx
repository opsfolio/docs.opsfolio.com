...
| --------------------------------------------- | ----------- | ----------------- | -------- | --------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_imap_acct_folder_message_id | VARCHAR     |                   | false    | [uniform_resource](/surveilr/standard-library/rssd-schema/uniform-resource) |                                                                             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
