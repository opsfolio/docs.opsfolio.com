...
| --------------------------------------------- | ----------- | ----------------- | -------- | --------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_imap_acct_folder_message_id | VARCHAR     |                   | false    | [uniform_resource](/surveilr/standard-library/rssd-schema/uniform_resource) |                                                                             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
| ingest_imap_acct_folder_id                    | VARCHAR     |                   | false    |                                         | [ur_ingest_session_imap_acct_folder](/surveilr/standard-library/rssd-schema/ur-ingest-session-imap-account-folder) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| message                                       | TEXT        |                   | false    |                                         |                                                                             |                                                         |
...
![er](/standard-library/rssd-schema/ur_ingest_session_imap_acct_folder_message.svg)