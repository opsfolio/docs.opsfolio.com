...
| uniform_resource_id           | VARCHAR     |                   | false    | [uniform_resource](/surveilr/standard-library/rssd-schema/uniform-resource) | uniform_resource row ID of original content             |
| uri                           | TEXT        |                   | false    |                                                                                   |                                                         |
...
![er](/standard-library/rssd-schema/uniform_resource_transform.svg)