...
| ---------------------- | ----------- | ----------------- | -------- | ----------------------------------- | ------------------------------------------------------- |
| party_relation_type_id | ULID        |                   | false    | [party_relation](/surveilr/standard-library/rssd-schema/party_relation) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
| code                   | TEXT        |                   | false    |                                     |                                                         |
| value                  | TEXT        |                   | false    |                                     |                                                         |
...
![er](/standard-library/rssd-schema/party_relation_type.svg)