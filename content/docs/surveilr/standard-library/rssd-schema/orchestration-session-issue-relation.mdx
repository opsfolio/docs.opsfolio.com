...
| issue_id_prime                          | UUID |         | false    | [orchestration_session_issue](/surveilr/standard-library/rssd-schema/orchestration_session_issue) | `{"isSqlDomainZodDescrMeta":true,"isUuid":true}`              |
