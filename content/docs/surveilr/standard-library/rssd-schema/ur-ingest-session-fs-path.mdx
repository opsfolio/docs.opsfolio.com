...
| ---------------------------- | ----------- | ----------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_fs_path_id | VARCHAR     |                   | false    | [uniform_resource](/surveilr/standard-library/rssd-schema/uniform-resource) [ur_ingest_session_fs_path_entry](/surveilr/standard-library/rssd-schema/ur-ingest-session-fs-path-entry) |                                                                                     | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_fs_path.svg)