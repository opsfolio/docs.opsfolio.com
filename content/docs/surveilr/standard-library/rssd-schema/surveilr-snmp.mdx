...
| device_key                | TEXT        |                   | false    | [surveilr_snmp_collection](/surveilr/standard-library/rssd-schema/surveilr_snmp)    | -                                              | Unique identifier for SNMP device                |
...
| device_key                  | TEXT        |                   | false    | -        | [surveilr_snmp_device](/surveilr/standard-library/rssd-schema/surveilr_snmp)     | Reference to SNMP device                    |
