...
| body_text                                   | TEXT        |                   | true     |                                                                                                                                   |                                                         |
| body_html                                   | TEXT        |                   | true     |                                                                                                                                   |                                                         |
| user                                        | VARCHAR     |                   | false    | [ur_ingest_session_plm_user](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-user)                             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_plm_comment.svg)