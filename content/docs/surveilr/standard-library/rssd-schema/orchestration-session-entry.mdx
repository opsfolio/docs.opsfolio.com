...
| ------------------------------ | ------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| orchestration_session_entry_id | VARCHAR |         | false    | [orchestration_session_state](/surveilr/standard-library/rssd-schema/orchestration-session-state) [orchestration_session_exec](/surveilr/standard-library/rssd-schema/orchestration-session-exec) [orchestration_session_issue](/surveilr/standard-library/rssd-schema/orchestration-session-issue) |                                                                                             | orchestration_session_entry primary key and internal label (UUID)             |
| session_id                     | VARCHAR |         | false    |                                                                                                                                                                                                                                                                                                                       | [orchestration_session](/surveilr/standard-library/rssd-schema/orchestration-session) | orchestration_session row this entry describes                                |
...
![er](/standard-library/rssd-schema/orchestration_session_entry.svg)