...
| -------------------------------- | ----------- | ----------------- | -------- | --------------------------------------------------------------------------- | ----------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_plm_account_id | VARCHAR     |                   | false    | [ur_ingest_session_plm_acct_project](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-project) |                                           | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_plm_account.svg)