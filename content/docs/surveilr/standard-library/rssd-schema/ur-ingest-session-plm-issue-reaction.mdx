...
| ur_ingest_plm_reaction_id               | VARCHAR     |                   | false    | [ur_ingest_session_plm_reaction](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-reaction)                     | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| ur_ingest_plm_issue_id                  | VARCHAR     |                   | false    | [ur_ingest_session_plm_acct_project_issue](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-project-issue) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_plm_issue_reaction.svg)