...
| ------------- | ----------- | ----------------- | -------- | ----------------- | ------------------------------------------------------- |
| party_type_id | ULID        |                   | false    | [party](/surveilr/standard-library/rssd-schema/party) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
| code          | TEXT        |                   | false    |                   |                                                         |
| value         | TEXT        |                   | false    |                   |                                                         |
...
![er](/standard-library/rssd-schema/party_type.svg)