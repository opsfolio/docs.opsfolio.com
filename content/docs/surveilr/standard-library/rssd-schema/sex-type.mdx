...
| ------------ | ----------- | ----------------- | -------- | ------------------- | ------------------------------------------------------- |
| sex_type_id  | ULID        |                   | false    | [person](/surveilr/standard-library/rssd-schema/person) | \{"isSqlDomainZodDescrMeta":true,"isUlid":true\}          |
| code         | TEXT        |                   | false    |                     |                                                         |
| value        | TEXT        |                   | false    |                     |                                                         |
...
![er](/standard-library/rssd-schema/sex_type.svg)