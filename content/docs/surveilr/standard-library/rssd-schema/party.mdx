...
| ------------- | ----------- | ----------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ------------------------------------------------------- |
| party_id      | VARCHAR     |                   | false    | [party_relation](surveilr/standard-library/rssd-schema/party-relation) [person](/surveilr/standard-library/rssd-schema/person) [organization](/surveilr/standard-library/rssd-schema/organization) [organization_role](/surveilr/standard-library/rssd-schema/organization-role) [device_party_relationship](/surveilr/standard-library/rssd-schema/device-party-relationship) |                             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| party_type_id | ULID        |                   | false    |                                                                                                                                                                                             | [party_type](/surveilr/standard-library/rssd-schema/party_type) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
...
![er](/standard-library/rssd-schema/party.svg)