...
| ------------- | ----------- | ----------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ------------------------------------------------------- |
| party_id      | VARCHAR     |                   | false    | [party_relation](/surveilr/standard-library/rssd-schema/party_relation) [person](/surveilr/standard-library/rssd-schema/person) [organization](/surveilr/standard-library/rssd-schema/organization) [organization_role](/surveilr/standard-library/rssd-schema/organization_role) [device_party_relationship](/surveilr/standard-library/rssd-schema/device-party-relationship) |                             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
