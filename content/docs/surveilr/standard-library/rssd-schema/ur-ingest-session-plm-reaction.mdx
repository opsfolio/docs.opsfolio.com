...
| --------------------------------- | ----------- | ----------------- | -------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_plm_reaction_id | VARCHAR     |                   | false    | [ur_ingest_session_plm_issue_reaction](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-issue-reaction) | \{"isSqlDomainZodDescrMeta":true,"isVarChar":true\}       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_plm_reaction.svg)