...
| ------------- | ----------- | ----------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| device_id     | VARCHAR     |                   | false    | [device_party_relationship](/surveilr/standard-library/rssd-schema/device_party_relationship) [behavior](/surveilr/standard-library/rssd-schema/behavior) [ur_ingest_session](/surveilr/standard-library/rssd-schema/ur-ingest-session) [uniform_resource](/surveilr/standard-library/rssd-schema/uniform-resource) [orchestration_session](/surveilr/standard-library/rssd-schema/orchestration-session) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`                                                |
