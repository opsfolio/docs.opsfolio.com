...
| ingest_fs_path_id                  | VARCHAR     |                   | false    | [ur_ingest_session_fs_path](/surveilr/standard-library/rssd-schema/ur-ingest-session-fs-path) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| uniform_resource_id                | VARCHAR     |                   | true     | [uniform_resource](/surveilr/standard-library/rssd-schema/uniform-resource)                   | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_fs_path_entry.svg)