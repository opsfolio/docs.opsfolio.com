...
| --- | --- | --- | --- |
| [party_type](/docs/standard-library/rssd-schema/party_type) | 10 | | table |
| [party](/docs/standard-library/rssd-schema/party) | 11 | Entity representing parties involved in business transactions. | table |
| [party_relation_type](/docs/standard-library/rssd-schema/party_relation_type) | 10 | | table |
...
| [gender_type](/docs/standard-library/rssd-schema/gender_type) | 10 | | table |
| [sex_type](/docs/standard-library/rssd-schema/sex_type) | 10 | | table |
| [person_type](/docs/standard-library/rssd-schema/person_type) | 10 | | table |
| [person](/docs/standard-library/rssd-schema/person) | 19 | Entity to store information about individuals as persons. Each person has a unique ID associated with them. | table |
| [organization](/docs/standard-library/rssd-schema/organization) | 16 | Entity to store information about organizations. Each organization has a unique ID associated with it. | table |
| [organization_role_type](/docs/standard-library/rssd-schema/organization_role_type) | 10 | Entity to store different types of organization roles. Each role is identified by a unique code and has an associated value/description. | table |
...
| [ur_ingest_session_imap_acct_folder_message](/docs/standard-library/rssd-schema/ur_ingest_session_imap_acct_folder_message) | 19 | Contains messages related in a folder that was ingested. | table |
