...
| person_id                 | VARCHAR     |                   | false    | [party](/surveilr/standard-library/rssd-schema/party)                                   | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| organization_id           | VARCHAR     |                   | false    | [party](/surveilr/standard-library/rssd-schema/party)                                   | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| organization_role_type_id | ULID        |                   | false    | [organization_role_type](/surveilr/standard-library/rssd-schema/organization-role-type) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
...
![er](/standard-library/rssd-schema/organization_role.svg)