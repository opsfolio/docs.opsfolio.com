...
| organization_role_type_id | ULID        |                   | false    | [organization_role_type](/surveilr/standard-library/rssd-schema/organization_role_type) | `{"isSqlDomainZodDescrMeta":true,"isUlid":true}`          |
