...
| ur_ingest_session_plm_acct_project_id       | VARCHAR     |                   | false    | [ur_ingest_session_plm_acct_project](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-project)             | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| ur_ingest_session_plm_acct_project_issue_id | VARCHAR     |                   | false    | [ur_ingest_session_plm_acct_project_issue](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-project-issue) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| lebel                                       | TEXT        |                   | false    |                                                                                                                                   |                                                         |
...
![er](/standard-library/rssd-schema/ur_ingest_session_plm_acct_label.svg)