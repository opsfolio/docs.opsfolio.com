...
| ------------------------------------- | ----------- | ----------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------- |
| ur_ingest_session_plm_acct_project_id | VARCHAR     |                   | false    | [uniform_resource](/surveilr/standard-library/rssd-schema/uniform-resource) [ur_ingest_session_plm_acct_project_issue](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-project-issue) [ur_ingest_session_plm_acct_label](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-label) [ur_ingest_session_plm_milestone](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-milestone) [ur_ingest_session_plm_acct_relationship](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account-relationship) |                                                                   | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| ingest_session_id                     | VARCHAR     |                   | false    |                                                                                                                                                                                                                                                                                                                                                                     | [ur_ingest_session](/surveilr/standard-library/rssd-schema/ur-ingest-session)                         | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
| ingest_account_id                     | VARCHAR     |                   | false    |                                                                                                                                                                                                                                                                                                                                                                     | [ur_ingest_session_plm_account](/surveilr/standard-library/rssd-schema/ur-ingest-session-plm-account) | `{"isSqlDomainZodDescrMeta":true,"isVarChar":true}`       |
...
![er](/standard-library/rssd-schema/ur_ingest_session_plm_acct_project.svg)