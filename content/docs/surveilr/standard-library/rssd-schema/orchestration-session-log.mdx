...
| ---------------------------- | ------- | ------- | -------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| orchestration_session_log_id | UUID    |         | false    | [orchestration_session_log](/surveilr/standard-library/rssd-schema/orchestration_session_log) |                                                                                                     | `{"isSqlDomainZodDescrMeta":true,"isUuid":true}`              |
| category                     | TEXT    |         | true     |                                                                                                     |                                                                                                     |                                                             |
| parent_exec_id               | UUID    |         | true     |                                                                                                     | [orchestration_session_log](/surveilr/standard-library/rssd-schema/orchestration_session_log) | `{"isSqlDomainZodDescrMeta":true,"isUuid":true}`              |
| content                      | TEXT    |         | false    |                                                                                                     |                                                                                                     |                                                             |
