...
| ----------------------- | --------- | ----------------- | -------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| code_notebook_kernel_id | VARCHAR   |                   | false    | [code_notebook_cell](/surveilr/standard-library/notebooks-schema/code-notebook-cell) | code_notebook_kernel primary key and internal label (not a ULID)                                   |
...
![er](/standard-library/notebooks-schema/code_notebook_kernel.svg)