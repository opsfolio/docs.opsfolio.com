...
| code_notebook_cell_id  | VARCHAR   |                   | false    | [code_notebook_cell](/surveilr/standard-library/notebooks-schema/code_notebook_cell) | code_notebook_cell row this state describes                               |
...
![er](/standard-library/notebooks-schema/code_notebook_state.svg)