...
| code_notebook_cell_id  | VARCHAR   |                   | false    | [code_notebook_cell](/surveilr/standard-library/notebooks-schema/code-notebook-cell) | code_notebook_cell row this state describes                               |
