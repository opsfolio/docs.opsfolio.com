...
| ----------------------- | --------- | ----------------- | -------- | --------------------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| code_notebook_cell_id   | VARCHAR   |                   | false    | [code_notebook_state](/surveilr/standard-library/notebooks-schema/code-notebook-state) |                                                 | code_notebook_cell primary key                                                                    |
| notebook_kernel_id      | VARCHAR   |                   | false    |                                               | [code_notebook_kernel](/surveilr/standard-library/notebooks-schema/code-notebook-kernel) | \{"isSqlDomainZodDescrMeta":true,"isVarChar":true\}                                                 |
...
![er](/standard-library/notebooks-schema/code_notebook_cell.svg)