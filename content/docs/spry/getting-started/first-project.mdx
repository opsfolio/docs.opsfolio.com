...
- **Spry** installed ([Installation Guide](/docs/spry/getting-started/installation))
...
<Cards>
  <Card title="Frontmatter Configuration" href="/docs/spry/core-concepts/fundamental-building-blocks#frontmatter">
    Using `sqlpage-conf` to configure database connection and server settings
  </Card>
  
  <Card title="Environment Variables" href="/docs/spry/reference-guides/configuration#environment-variables">
    Interpolating values with `${env.SPRY_DB}` syntax
  </Card>
  
  <Card title="Executable Cells" href="/docs/spry/core-concepts/code-cells#executable-cells">
    Running bash scripts to create and populate databases
  </Card>
  
  <Card title="Materializable Cells" href="/docs/spry/core-concepts/code-cells#materializable-cells">
...
|---------|-------------------|---------------------|
| **Frontmatter** | `sqlpage-conf` with database URL and port | [Configuration Reference](/docs/spry/core-concepts/fundamental-building-blocks#frontmatter) |
| **Environment Variables** | `${env.SPRY_DB}` interpolation | [Core Concepts](/docs/spry/reference-guides/configuration#environment-variables) |
| **Executable Cells** | `bash prepare-db` task | [Code Cells](/docs/spry/core-concepts/fundamental-building-blocks#cells) |
| **Materializable Cells** | `sql index.sql` page definition | Cell Types |
| **PARTIAL Directive** | `global-layout.sql` injected everywhere | [Directives](/docs/spry/reference-guides/configuration#partial-directive) |
| **Route Attributes** | `{ route: { caption: "Home" } }` metadata | [SQLPage Integration](/docs/spry/core-concepts/sql-page-integration) |
...
<Cards>
  <Card title="Learn More About Spryfiles" href="/docs/spry/core-concepts/executable-markdown">
    Understand the structure and capabilities of executable Markdown
  </Card>
  
  <Card title="Explore Code Cells" href="/docs/spry/core-concepts/fundamental-building-blocks#cells">
    Master different cell types and execution patterns
  </Card>
  
  <Card title="Build Complex Workflows" href="/docs/spry/use-cases/devops-runbook">
    Create multi-step automation with task dependencies
  </Card>
  
  <Card title="CLI Reference" href="/docs/spry/reference-guides/cli-commands">
