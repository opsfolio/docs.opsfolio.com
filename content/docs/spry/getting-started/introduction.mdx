...
### [Executable Markdown](/docs/spry/core-concepts/executable-markdown)
...
### [Task Dependencies](/docs/spry/core-concepts/task-orchestration)
...
### [SQLPage Integration](/docs/spry/use-cases/sqlpage-data-app)
...
### [Audit-Ready Evidence](/docs/spry/use-cases/audit-complains)
...
<Cards>
  <Card title="Policies as Code" href="/docs/spry/use-cases/audit-complains">
    Create verifiable test cases for compliance frameworks with automated evidence capture.
  </Card>
  
  <Card title="Data Applications" href="/docs/spry/use-cases/sqlpage-data-app">
    Build SQLite or PostgreSQL-backed dashboards with SQLPage integration.
  </Card>
  
  <Card title="Executable Runbooks" href="/docs/spry/use-cases/devops-runbook">
