...
### [Executable Markdown](/spry/core-concepts/executable-markdown)
...
### [Task Dependencies](/spry/core-concepts/task-orchestration)
...
### [SQLPage Integration](/spry/use-cases/sqlpage-data-app)
...
### [Audit-Ready Evidence](/spry/use-cases/audit-complains)
...
<Cards>
  <Card title="Policies as Code" href="/spry/use-cases/audit-complains">
    Create verifiable test cases for compliance frameworks with automated evidence capture.
  </Card>
  
  <Card title="Data Applications" href="/spry/use-cases/sqlpage-data-app">
    Build SQLite or PostgreSQL-backed dashboards with SQLPage integration.
  </Card>
  
  <Card title="Executable Runbooks" href="/spry/use-cases/devops-runbook">
